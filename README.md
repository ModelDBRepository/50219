...
<center>
![Network](index_files/network.gif)
</center>

### A network model of the granular layer of cerebellar cortex ([Maex](mailto:reinoud@tnb.ua.ac.be) and De Schutter)
...
(Note from the ModelDB administrator: some web links below converted to reveal the original URL in case you want to find them in the wayback machine (dates in 2006 work)):

[GENESIS2.1 scripts for this 1997 network model of the granular layer of cerebellar cortex](http://senselab.med.yale.edu/modeldb/data/50219/network_scripts.tar) as described in:
[Maex, R. and De Schutter, E.: Synchronization of Golgi and granule cell firing in a detailed network model of the cerebellar granular layer. *Journal of Neurophysiology* 80: 2521-2537 (1998).](http://www.tnb.ua.ac.be/publications/pub025/TNB_pub25.shtml)
...
- (http://www.tnb.ua.ac.be/publications/publications.shtml) publications
- (http://www.tnb.ua.ac.be/models/models.shtml) models
- (http://www.tnb.ua.ac.be/links/links.shtml) servers
- (http://www.tnb.ua.ac.be/courses/courses.shtml) courses
- (http://www.tnb.ua.ac.be/search/search.shtml) search
- (http://www.tnb.ua.ac.be/contact/contact.shtml) contact
- (http://www.tnb.ua.ac.be/SOFT/downloads.shtml) software
- (http://www.tnb.ua.ac.be/lab/index.shtml) lab only
- (http://www.tnb.ua.ac.be/home.shtml) home

(http://www.tnb.ua.ac.be/home.shtml) **[NO FRAMES]**

(http://www.tnb.ua.ac.be/index.shtml) **[RELOAD FRAMES AND HOMEPAGE]**

Please send comments and suggestions to Mike Wijnants at (http://www.tnb.ua.ac.be/u/mike/index.shtml)
